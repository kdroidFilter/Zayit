    ...
    if (isDark) {
        if (includeH3) {
            MarkdownStyling.Heading.dark(
                baseTextStyle = textStyle,
                h2 = MarkdownStyling.Heading.H2.dark(baseTextStyle = h2TextStyle, padding = h2Padding),
                h3 = MarkdownStyling.Heading.H3.dark(baseTextStyle = h3TextStyle, padding = h3Padding),
            )
        } else {
            MarkdownStyling.Heading.dark(
                baseTextStyle = textStyle,
        ...
        if (includeH3) {
            MarkdownStyling.Heading.light(
                baseTextStyle = textStyle,
                h2 = MarkdownStyling.Heading.H2.light(baseTextStyle = h2TextStyle, padding = h2Padding),
                h3 = MarkdownStyling.Heading.H3.light(baseTextStyle = h3TextStyle, padding = h3Padding),
            )
        } else {
            MarkdownStyling.Heading.light(
                baseTextStyle = textStyle,
